                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input
                          ...
                          required
                          className="bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-cyan-400"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          required
                          className="w-full bg-white/5 border border-white/10 text-white rounded-md px-3 py-2 focus:border-cyan-400 focus:outline-none"
                        >
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        required
                        rows={4}
                        className="bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-cyan-400 resize-none"
                    ...
                    <Button
                      ...
                      className="w-full bg-white text-black hover:bg-gray-200 font-semibold py-3 rounded-full text-lg disabled:opacity-50"
                    >
                      {isSubmitting ? (
                        "Sending..."
                      ) : (
